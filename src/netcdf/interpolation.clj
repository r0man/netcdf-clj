...
(defmethod interpolate :2x2 [matrix x-fract y-fract]
  (. *interpolation* interpolate
     (double (sel matrix 0 0))
     (double (sel matrix 0 1))
     (double (sel matrix 1 0))
     (double (sel matrix 1 1))
     (float x-fract)
     (float y-fract)))
...
(defmethod interpolate :4x4 [matrix x-fract y-fract]
  (. *interpolation* interpolate
     (double (sel matrix 0 0))
     (double (sel matrix 0 1))
     (double (sel matrix 0 2))
     (double (sel matrix 0 3))
     (double (sel matrix 1 0))
     (double (sel matrix 1 1))
     (double (sel matrix 1 2))
     (double (sel matrix 1 3))
     (double (sel matrix 2 0))
     (double (sel matrix 2 1))
     (double (sel matrix 2 2))
     (double (sel matrix 2 3))
     (double (sel matrix 3 0))
     (double (sel matrix 3 1))
     (double (sel matrix 3 2))
     (double (sel matrix 3 3))
     (float x-fract)
     (float y-fract)))
