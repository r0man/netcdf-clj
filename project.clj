(defproject netcdf-clj "0.0.11-SNAPSHOT"
  ...
  :dependencies [[cascalog "2.1.1"]
                 ...
                 [digest "1.4.4"]
                 [edu.ucar/netcdf4 "5.0.0"]
                 [edu.ucar/opendap "5.0.0"]
  ...
  :profiles {:dev {:dependencies [[ch.qos.logback/logback-classic "1.1.3"]
             ...
             :provided {:dependencies [[org.apache.hadoop/hadoop-core "2.6.0-mr1-cdh5.6.0"]
